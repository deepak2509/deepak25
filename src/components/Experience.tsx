...
const experienceData: ExperienceItem[] = [
  {
    ...
    skills: ["Python", "TensorFlow", "deeplearning", "machinelearning"],
    type: "work"
  },
  {
    id: 2,
    ...
    skills: ["Python", "HTML", "CSS", "JS", "Reactjs"],
    type: "work"
  },
  {
    id: 4,
    ...
    description: [
      ...
      "Research focus on deep learning applications in additive manufacturing",
      "GPA: 3.5/4.0"
    ],
    achievements: [
  
      "Research Assistant,which focus on machinelearning,deeplearning",
  ...
  },
  {
    ...
    achievements: [
      "Led student project developing a predictive app for campus events",
      "President of Computer Science Codingclub"
    ],
    type: "education"
  }
];
